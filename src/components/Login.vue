<template>
    <div v-show="this.resultadoLogin == false">
        <div class="w-full md:w-1/2 h-1/2 bg-lime-300 p-8 flex flex-col mt-12 mx-auto">
            <div class="h-auto">
    ...
    methods:{
        ...
        ValidarLogin(){
            const resultado = this.usuarios.filter((usuario) => 
                this.usuario.nombre.trim() == usuario.nombre && this.usuario.password == usuario.password
            )
